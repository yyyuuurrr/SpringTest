...
public class Test02Controller {
	...
	@RequestMapping("/1")
	public Map<String, Object> movieResponse() {
	...
	public Map<String, Object> infoMap() {
		...
		infoMap.put("title", "안녕하세요 가입인사 드립니다.");
		infoMap.put("user", "hagulu");
		infoMap.put("content", "안녕하세요. 앞으로 잘 부탁드립니다.");
		
		infoMap.put("title", "헐 대박");
		infoMap.put("user", "bada");
		infoMap.put("content", "오늘 목요일이었어... 금요일인줄");

		infoMap.put("title", "오늘 데이트 한 이야기 해드릴게요.");
		infoMap.put("user", "dulumary");
		infoMap.put("content", "......");
